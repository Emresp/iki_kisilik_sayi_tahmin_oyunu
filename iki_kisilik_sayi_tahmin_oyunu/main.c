...
int main(void)
{
    ...
    if (strcmp(karar,"basla")==0)
    {
        ...
        printf("%s adli oyuncu %d. denemede bilmistir asagıda oyun sonun tablosu bulunmaktadir\n",isim2,sayac2);
    }
    else
    {
    ...
    {
        printf("%s ve %s adlı oyuncların ikiside %d. denemsinde bildigi icin kazanan yok",isim1,isim2,sayac1);
        printf("Oynadiginiz icin tesekkurler");
    }
